...
class CrowdMonitoringManager {
    ...
    updateLiveStats() {
        ...
        // Update density level color based on value
        if (density > 80) {
            densityLevel.className = 'progress-bar bg-danger';
        } else if (density > 60) {
            densityLevel.className = 'progress-bar bg-warning';
        } else {
            densityLevel.className = 'progress-bar bg-success';
        }
    }
